...
<%
	...
	KeycapDAO keycapDAO = new KeycapDAO();
	Collection<Keycap> keycaps = keycapDAO.findAll();
%>
<% if (keycaps.isEmpty()) { %>
	<p>Nessun keycap disponibile</p>
<% } else { %>
	<div class="grid">
		<% for (Keycap keycap : keycapDAO.findAll()) { %>
			<%
				Articolo articolo = articoloDAO.findById(keycap.getArticoloId());
